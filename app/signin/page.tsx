...
import googleAuth from "@/utils/mutations/user/oauth/googleAuth"; 
import slackAuth from "@/utils/mutations/user/oauth/slackAuth";
import githubAuth from "@/utils/mutations/user/oauth/githubAuth";
            ...
            >
                ...
                <div className="flex flex-col gap-4 justify-center mt-10 max-md:mt-0 p-5">
                    ...
                    <button 
                        ...
                        className="btn btn-lg bg-[#622069] text-white border-[#591660] w-[400px] max-md:w-[300px]">
                    ...
                    <button 
                        className="btn btn-lg bg-black text-white border-black  w-[400px] max-md:w-[300px]"
                        onClick={async () => {
                            setLoading(true);
                            await githubAuth();
                            setLoading(false);
